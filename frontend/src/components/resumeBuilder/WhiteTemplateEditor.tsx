...
const WhiteTemplateEditor = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <EditorHeader
                templateName="Sales Representative"
                                ...
                                {resumeData.experience.map((exp) => (
                                    <div key={exp.id} className="mb-6">
                                        <div className="flex justify-between items-start mb-2">
                                            <div>
                                                <EditableField
                                                    ...
                                                    className="text-xl font-semibold text-gray-800 block mb-1"
                                                    isPreviewMode={isPreviewMode}
                                                />
                                                <EditableField
                                                    value={exp.company}
                                        ...
                                        <EditableField
                                            ...
                                            className="text-gray-700 leading-relaxed w-full mt-2"
                                            multiline
                                            isPreviewMode={isPreviewMode}
                                        />
                                    </div>
                                    ...
                                    {resumeData.education.map((edu) => (
                                        <div key={edu.id} className="mb-4">
                                            ...
                                            <EditableField
                                                ...
                                                className="text-blue-600 block mb-1"
                                                isPreviewMode={isPreviewMode}
                                            />
                                            <EditableField
                                                value={edu.year}
...
export default WhiteTemplateEditor;