                            ...
                            <table className="w-full table-auto border-collapse">
                                <thead>
                                    <tr className="bg-gray-100 text-left text-sm">
                                        ...
                                        <th className="p-2 border">Update Status</th> {/* Moved to right end */}
                                    </tr>
                                </thead>
                                <tbody>
                                    {job.applicants.map((applicant) => (
                                        <tr key={applicant.applicationId} className="text-sm hover:bg-gray-50">
                                            <td className="p-2 border">{applicant.applicant.name}</td>
                                            <td className="p-2 border">{applicant.applicant.email}</td>
                                            ...
                                            <td className="p-2 border"> {/* Moved to right end */}
                                                <select
